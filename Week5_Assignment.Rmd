...
* anth_risk - Raster Layer (Albers Equal Area Coordinate Reference System)
* fence_dist - Raster Layer (Albers Equal Area Coordinate Reference System)
* prirds_dist - Raster Layer (Albers Equal Area Coordinate Reference System)
* secrds_dist - Raster Layer (Albers Equal Area Coordinate Reference System)
* river_dist - Raster Layer (Albers Equal Area Coordinate Reference System)
* waterpts_dist - Raster Layer (Albers Equal Area Coordinate Reference System)
* woody_dist - Raster Layer (Albers Equal Area Coordinate Reference System)

**Question 1**: Are all files spatial and in the same coordinate reference system?  If no, make all files spatial and make sure their projections match.  Use the same projection information provide in class (Albers Equal Area).
